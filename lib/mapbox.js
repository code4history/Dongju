...
function makeACKEYURL(url, accessToken) {
  return url.replace(/YOUR\-API\-KEY/, accessToken)
}
...
exports.normalizeStyleURL = function (url, accessToken) {
  if (!isMapboxURL(url)) return makeACKEYURL(url, accessToken)
...
exports.normalizeSpriteURL = function (url, format, extension, accessToken) {
  ...
  if (!isMapboxURL(url)) {
    ...
    return makeACKEYURL(formatUrl(urlObject), accessToken)
  }
